...
query = urllib.parse.quote("Amistosos Internacionales")
...
with open('c:/Users/luism/.gemini/antigravity/scratch/codex_ss/serpapi_amistosos.json', 'w', encoding='utf-8') as f:
