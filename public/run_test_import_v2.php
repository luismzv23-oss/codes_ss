...
foreach ($staged as &$e) {
    ...
    echo "Match: {$e['home_team']} (hex: " . bin2hex($e['home_team']) . ") vs {$e['away_team']} (hex: " . bin2hex($e['away_team']) . ")\n";
    echo "  - Direct home flag lookup: '" . ($loader->getFlagForTeam($e['home_team']) ?? 'NULL') . "'\n";
    echo "  - Direct away flag lookup: '" . ($loader->getFlagForTeam($e['away_team']) ?? 'NULL') . "'\n";
